...
"""task6combiner.py: Receives key, value pairs (pair of subsequent words, number of occurences), counts total number of occurences per pair of subsequent words"""
